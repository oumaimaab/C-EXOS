...
namespace App.ServiceReferenceConverter {
    using System.Data;
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ServiceReferenceConverter.ConverterSoap")]
    public interface ConverterSoap {
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        App.ServiceReferenceConverter.ConvertDataTableColumnResponse ConvertDataTableColumn(App.ServiceReferenceConverter.ConvertDataTableColumnRequest request);
        
        // CODEGEN : Génération du contrat de message dans la mesure où l'opération compte plusieurs valeurs de retour.
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ConvertDataTableColumn", ReplyAction="*")]
        System.Threading.Tasks.Task<App.ServiceReferenceConverter.ConvertDataTableColumnResponse> ConvertDataTableColumnAsync(App.ServiceReferenceConverter.ConvertDataTableColumnRequest request);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ConverterSoapChannel : App.ServiceReferenceConverter.ConverterSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ConverterSoapClient : System.ServiceModel.ClientBase<App.ServiceReferenceConverter.ConverterSoap>, App.ServiceReferenceConverter.ConverterSoap {
        ...
        App.ServiceReferenceConverter.ConvertDataTableColumnResponse App.ServiceReferenceConverter.ConverterSoap.ConvertDataTableColumn(App.ServiceReferenceConverter.ConvertDataTableColumnRequest request) {
        ...
        public void ConvertDataTableColumn(ref System.Data.DataSet ds, int TableIndex, string ColumnName, string FromCurrency, string ToCurrency) {
            App.ServiceReferenceConverter.ConvertDataTableColumnRequest inValue = new App.ServiceReferenceConverter.ConvertDataTableColumnRequest();
            inValue.ds = ds;
            inValue.TableIndex = TableIndex;
            inValue.ColumnName = ColumnName;
            inValue.FromCurrency = FromCurrency;
            inValue.ToCurrency = ToCurrency;
            App.ServiceReferenceConverter.ConvertDataTableColumnResponse retVal = ((App.ServiceReferenceConverter.ConverterSoap)(this)).ConvertDataTableColumn(inValue);
            ds = retVal.ds;
        }
        
        public System.Threading.Tasks.Task<App.ServiceReferenceConverter.ConvertDataTableColumnResponse> ConvertDataTableColumnAsync(App.ServiceReferenceConverter.ConvertDataTableColumnRequest request) {
